...
O controlador dos dados é [PREENCHER: razão social da academia], CNPJ [PREENCHER: CNPJ], com endereço em [PREENCHER: endereço completo].

Canal para assuntos de privacidade: [PREENCHER: e-mail ou telefone de contato]. Pessoa responsável pelo atendimento (encarregado): [PREENCHER: nome do encarregado ou indicação de agente de pequeno porte, a confirmar com a assessoria jurídica].
...
Dado de saúde enviado numa justificativa: [PREENCHER: base legal do art. 11 confirmada pela assessoria jurídica].
...
- Cloudinary: armazenamento das imagens de comprovante e dos anexos de justificativa. [PREENCHER: região da conta Cloudinary].
...
Como parte desses serviços fica fora do Brasil, há transferência internacional de dados. Ela é feita [PREENCHER: mecanismo do art. 33 da LGPD adotado, por exemplo cláusulas-padrão contratuais da Resolução CD/ANPD nº 19/2024, confirmado pela assessoria jurídica].
...
- mensalidades (valores, vencimentos e situação), por [PREENCHER: prazo definido com o contador];
- presenças e faltas, para as estatísticas da academia.

Outros prazos:
- imagens de comprovante de mensalidades pagas: [PREENCHER: prazo em dias após o pagamento, ou "enquanto a conta existir"];
...
- trilha de auditoria: [PREENCHER: prazo];
- cópias de segurança do banco de dados: [PREENCHER: prazo de retenção dos backups].
...
[PREENCHER: como a academia cadastra alunos menores de 18 anos, quem é o responsável que consente e como ele exerce os direitos do titular, conforme o art. 14 da LGPD].
