...
| --- | --- | --- |
| `snake-thai` | [`ROADMAP-thai.md`](../ROADMAP-thai.md) | **O banco** (migrations, RPCs, RLS, Edge Functions) e o app Android |
| `snake-server` | `../snake-server/ROADMAP-server.md` | As rotas `/v1/*` e o worker de limpeza de mídia |
| `snake-web` | `../snake-web/ROADMAP-web.md` | A web do aluno |
